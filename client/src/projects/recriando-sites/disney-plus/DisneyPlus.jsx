        ...
        <div id="disney-plus" className={styles.body}>
              ...
              <div id="container-1">
                <div className={styles.precosContainer}>
                  ...
                  <div className={styles.assinarInfos}>
                    ...
                    <p className={`${styles.text1} ${styles.jump} ${styles.p}`}>
                      *O preço pode variar caso a assinatura seja feita através
                    ...
                    <p className={`${styles.text2} ${styles.jump} ${styles.p}`}>
          ...
          <footer className={styles.footer}>
            ...
            <p className={styles.p}>
              ...
              direitos reservados. Serviço de assinatura paga. Conteúdo sujeito
              a disponibilidade.
              <br />
              <br />
              <br />
              ...
              Nações Unidas, 12.551, 12.555, 12.559, Piso 10, São Paulo/SP – CEP
              04578-903, Brasil e CNPJ/M 73.042.962/0004-20
            </p>
          </footer>
          <ProjectsNote />
        </div>,
