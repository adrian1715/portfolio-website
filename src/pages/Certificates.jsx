...
export const courses = {
  // all items must be passed as an array
  anhembi: [
    { id: 1, name: "Diploma de Conclusão de Curso", certified: true },
    { id: 2, name: "Certificado de Conclusão de Curso", certified: true },
    {
      id: 3,
      name: "Graduation Course Completion Certificate (translated)",
      certified: true,
    },
    { id: 4, name: "Histórico Escolar Final", certified: true },
  ],
  alura: [
    {
      id: 14,
